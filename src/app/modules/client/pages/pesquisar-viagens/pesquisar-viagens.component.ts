...
@Component({
  selector: 'app-pesquisar-viagens',
  templateUrl: './pesquisar-viagens.component.html',
  styleUrls: ['./pesquisar-viagens.component.css']
})
export class PesquisarViagensComponent  implements OnInit{
